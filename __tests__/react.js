...
//3. The updatedItem function should be invoked when 'Update' button is clicked (is it being invoked here or just passed down?)
//4. The deletedItem function should be invoked when 'Delete' button is clicked

//Inventory Display Component
//TODO: Test the following:
//1. The page loads with five h4 elements, with following text:
//'ID', 'NAME', 'QUANTITY', 'CATEGORY', 'LOCATION'
//2. The addedItem function should be invoked when 'Add Item' button is clicked
...
//5. Need to test that the user is authenticated (put this should probably take place in supertests) 
